...
## Released.
execute if score @s egg.key.backward._previous matches 0.. if score @s egg.key.backward._current matches ..0 run return run scoreboard players get @s egg.key.backward._previous
## not Released.
return 0