...
## Released.
execute if score @s egg.key.sneak._previous matches 0.. if score @s egg.key.sneak._current matches ..0 run return run scoreboard players get @s egg.key.sneak._previous
## not Released.
return 0