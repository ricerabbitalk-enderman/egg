...
## Verify.
execute unless data storage egg:shock/give_to_anyone <<.distance run return fail
execute unless data storage egg:shock/give_to_anyone <<.amount run data modify storage egg:shock/give_to_anyone <<.amount set value 0
...
execute unless data storage egg:shock/give_to_anyone <<.preprocess run data modify storage egg:shock/give_to_anyone <<.preprocess set value "noop"
