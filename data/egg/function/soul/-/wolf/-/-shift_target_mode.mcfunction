...
execute on passengers on passengers run data modify storage egg:soul/-/wolf/dummy brain set from entity @s UUID
execute on passengers on passengers run ride @s dismount
execute on passengers run data modify storage egg:soul/-/wolf/dummy dummy set from entity @s UUID
